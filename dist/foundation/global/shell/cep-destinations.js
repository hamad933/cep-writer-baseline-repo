import {createShellDestinationRegistry,                               } from './destination-registry.js';
const d=(id       ,area       ,en       ,ar       ,enDescription       ,arDescription       )                           =>Object.freeze({id,area,labels:Object.freeze({ar,en}),description:Object.freeze({ar:arDescription,en:enDescription})});
