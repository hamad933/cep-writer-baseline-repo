...
const enterpriseAdapter=createEnterpriseAdapter({fixture:true});const enterpriseDomain=new W03EnterpriseDomain({relationAdapter:enterpriseAdapter,authoring:'PUBLISHED',revisionId:'ENT-PUBLISHED',baseline:{status:'AVAILABLE',id:'BL-1',revision:'1',digest:'sha256:baseline'}});
