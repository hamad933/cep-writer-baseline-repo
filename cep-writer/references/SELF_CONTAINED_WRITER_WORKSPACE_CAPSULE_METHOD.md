...
When multiple future missions depend on successive source results, build successor capsules from the exact Controller-adjudicated parent rather than pretending one older capsule contains future Product truth. Stable reference material may be reused; source identity must advance exactly.
