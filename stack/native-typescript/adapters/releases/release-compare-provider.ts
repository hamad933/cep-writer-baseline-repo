...
import type {ReleaseCandidate,ReleaseCandidateRef} from './domain-adapter.js';
...
export function releaseCandidateRef(row:ReleaseCandidate):ReleaseCandidateRef{
...
export function createReleaseCompareProvider(resolveCandidate:(ref:ReleaseCandidateRef)=>ReleaseCandidate|null){
  return createAnalyticalProviderBoundary({
    ...
    refKey(ref:ReleaseCandidateRef){return `${ref.candidateId}@${ref.commitSHA}:${ref.treeSHA}:${ref.artifactDigest}`;},
    resolve(ref:ReleaseCandidateRef){
