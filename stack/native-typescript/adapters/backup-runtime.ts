...
export class ProviderAwareBackupIntegrationAdapter{
  ...
  snapshot(){return {...this.semantic.snapshot(),durableAttempts:clone(this.durableAttempts),providerPreview:clone(this.lastProviderPreview),providerStage:clone(this.lastProviderStage)};}
