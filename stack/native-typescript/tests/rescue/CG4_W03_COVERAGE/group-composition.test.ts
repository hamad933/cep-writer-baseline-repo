...
const group=composeW03RescueGroup({shared,enterprise:{relationAdapter:createEnterpriseAdapter({fixture:true})},scenarios:{domain:scenarioDomain},labs:{domain:labDomain},results:{domainOptions:{records}}});
